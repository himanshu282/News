...
class MyAdapter(val context : Context,val interfaces : ClickInterface) : RecyclerView.Adapter<MyAdapter.MyViewHolder>() {
    ...
    class  MyViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        val downloadButton : ImageView = itemView.findViewById(R.id.download_btn)
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.downloadButton.setOnClickListener {
            interfaces.onClick(currentItem)
        }
